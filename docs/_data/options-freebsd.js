export const options = [
	...
	},
	{
		flag: 'apache24',
		label: 'Apache 2.4',
		description: 'Apache 2.4 (apache24) 是一款功能强大、高度可配置、广泛支持的开源 Web 服务器，用于提供高性能的网站托管服务。',
		default: 'yes',
	},
	{
        flag: 'phpfpm',
    ...
    },
    {
        flag: 'multiphp',
        label: 'MultiPHP',
        description: '允许选择安装多个 PHP 版本。默认安装系统首选的 PHP 8.3，不勾选安装后可通过 CLI 命令或 web 管理面板安装需要的版本。',
        default: 'no'
    },
    {
        flag: 'vsftpd',
        label: 'VSFTPD',
        description: 'VSFTPD 是一个安全、高速、稳定的 FTP 服务器软件，特别适用于高并发的网络服务环境，用于在服务器与用户之间提供安全、快速的文件传输。',
        default: 'yes'
    },
    {
        flag: 'proftpd',
        label: 'ProFTPD',
        description: 'ProFTPD 是一款高级模块化 FTP 服务器，支持通过 LDAP 进行用户身份验证和授权。',
        default: 'no'
    },
    {
        flag: 'named',
	...
	},
	{
		flag: 'dovecot',
		label: 'Dovecot',
		description: 'Dovecot 是一个开源的 IMAP 和 POP3 电子邮件服务器软件，为系统提供电子邮件服务。它以其安全性、易用性、速度和低资源消耗而著称。',
		default: 'yes'
	},
	{
		flag: 'sieve',
	...
	},
	{
        flag: 'packetfilter', 
        label: 'packetfilter',
        description: '启用 FreeBSD 内核级 packet filter (pf) 防火墙模块进行有状态安全规则管理，极大增强服务器原生安全性。',
        default: 'yes'
    },
    {
        flag: 'fail2ban',
        label: 'Fail2Ban',
        description: 'Fail2Ban 可以自动检测恶意攻击者，并自动联动内核级 PF 防火墙对无效身份验证（如 SSH、FTP）的来源 IP 进行实时封禁。',
        default: 'yes'
    },
    {
        flag: 'quota',
        label: '硬盘配额',
        description: '基于系统级原生文件系统驱动（如 ZFS Quotas）为普通虚拟主机用户设置磁盘空间限额，限制硬盘最大使用空间。',
        default: 'no'
    },
    {
        flag: 'webterminal',
    ...
    },
    {
        flag: 'force',
        label: '强制安装',
        description: '强制覆盖任何现有的系统配置和冲突文件进行覆盖安装，适合在干净的系统上覆盖默认管理员环境。',
        default: 'no'
    },
];