...
export const webDomains = [
	...
	apps: [//https://github.com/hestiacp/hestiacp/tree/release/web/src/app/WebApp/Installers
		...
		{ text: 'Flarum', iconType: 'image', icon: 'images/Flarum.svg' },
		{ text: 'Grav', iconType: 'image', icon: 'images/grav.svg' },
		{ text: 'Joomla', iconType: 'fontawesome', icon: 'fab fa-joomla' },
		{ text: 'Laravel', iconType: 'fontawesome', icon: 'fab fa-laravel' },
		{ text: 'MediaWiki', iconType: 'image', icon: 'images/mediawikiwiki.svg' },
		{ text: 'NamelessMC', iconType: 'image', icon: 'images/NamelessMC.svg' },
		{ text: 'NextCloud', iconType: 'image', icon: 'images/NextCloud.svg' },
		{ text: 'OpenCart', iconType: 'image', icon: 'images/OpenCart.svg' },
		{ text: 'Prestashop', iconType: 'image', icon: 'images/PrestaShop.svg' },
		{ text: 'Symfony', iconType: 'image', icon: 'images/Symfony.svg' },
		{ text: 'ThirtyBees', iconType: 'image', icon: 'images/ThirtyBees.svg' },
		{ text: 'Vvveb', iconType: 'image', icon: 'images/Vvveb.png' },
		{ text: 'WordPress', iconType: 'fontawesome', icon: 'fab fa-wordpress' }
	  ]
	},
];
