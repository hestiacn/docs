	...
	<div class="InstallBuilder">
		<div class="container">
			<div class="output-card">
				<h1 class="u-text-center">FreeBSD系安装说明</h1>
				...
				<CopyToClipboardInput
					class="u-mb10"
					value="Currently under development and adaptation testing. Stay tuned! Thank you for your support of Hestia."
				...
				<CopyToClipboardInput
					class="u-mb10"
					value="正在开发适配测试中，敬请期待！感谢你对hestia的支持！"
					style="font-size: 1.2em;"/>
