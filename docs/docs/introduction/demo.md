...
* [演示模式启用脚本查看](https://hestiamb.org/bin/hooks/post_install)

* [演示模式禁用脚本查看](https://hestiamb.org/bin/hooks/pre_install)

* [演示安装文档查看](https://hestiamb.org/bin/hooks/instll.html)
